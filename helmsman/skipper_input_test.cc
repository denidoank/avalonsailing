...
TEST(SkipperInput, All) {
  ...
  // mag_true missing
  int chars_read = t.FromString("skipper_input: timestamp_ms:7 latitude_deg:11.10 longitude_deg:10 "
                                "angle_true_deg:-33 \n");
  EXPECT_EQ(4000000000LL, t.timestamp_ms);
  EXPECT_EQ(10, s.longitude_deg);
  EXPECT_EQ(11.1, s.latitude_deg);
  EXPECT_EQ(-33, s.angle_true_deg);
  EXPECT_EQ(4, s.mag_true_kn);
  ...
  chars_read = t.FromString("skipper_input: timestamp_ms:7 latitude_deg:11.10 longitude_deg:10 "
                            "angle_true_deg:-33 mag_true_kn:7.7\n");
  ...
  chars_read = t.FromString("skipper_input: timestamp_ms:7 latitude_deg:11.10 longitude_deg:10 "
                            "angle_true_deg:-33 mag_true_knots:7.7\n");
  EXPECT_EQ(7LL, t.timestamp_ms);
  EXPECT_EQ(10, t.longitude_deg);
  EXPECT_EQ(11.1, t.latitude_deg);
  EXPECT_EQ(-33, t.angle_true_deg);
