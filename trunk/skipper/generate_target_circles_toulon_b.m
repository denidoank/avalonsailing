...
function generate_target_circles_toulon_b
% function generate_target_circles_toulon_b.m
% For a trip from Toulon to the sea and back.
% Script to make const table for the route of the boat,
% in C++.
% Produces a file named "target_circle_points_table_toulon_b.h" in the current directory.
...
[fid, msg] = fopen("target_circle_points_table_toulon_b.h", "w");
if fid == -1
  msg
  error(msg);
  return;
