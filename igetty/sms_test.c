...
int test_check_buffer_size() {
	if (EncodeSMS("001234567", "1234567", "hellohello", NULL, 0) >=0 ) {
...
int test_sms_encode() {
	...
	int buffer_length = EncodeSMS("27381000015", "46708251358", "hellohello", buffer, sizeof(buffer));
...
int test_sms_decode() {
	...
	int sms_text_length = DecodeSMS(buffer, sizeof(buffer),
					&sms_time,
