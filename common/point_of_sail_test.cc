...
TEST(PointOfSailTest, AntiWindGust) {
  ...
  double alpha_app = Deg2Rad(90);
  double mag_app = 1;
  EXPECT_FLOAT_EQ(0, p.AntiWindGust(JibeStar, alpha_app, mag_app));
  EXPECT_FLOAT_EQ(0, p.AntiWindGust(ReachStar, alpha_app, 0));
